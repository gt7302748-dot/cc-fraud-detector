...
export class Backend implements backendInterface {
    ...
    async analyzeTransaction(arg0: Array<number>): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.analyzeTransaction(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAutoencoderMetrics(): Promise<AutoencoderMetrics> {
        if (this.processError) {
            try {
                const result = await this.actor.getAutoencoderMetrics();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getConfusionMatrix(): Promise<ConfusionMatrix> {
        if (this.processError) {
            try {
                const result = await this.actor.getConfusionMatrix();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEdaStats(): Promise<EdaStats> {
        if (this.processError) {
            try {
                const result = await this.actor.getEdaStats();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFeatureImportance(): Promise<Array<FeatureImportance>> {
        if (this.processError) {
            try {
    ...
    async getModelScores(): Promise<Array<ModelScore>> {
        if (this.processError) {
            try {
                const result = await this.actor.getModelScores();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRocCurve(): Promise<Array<RocPoint>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRocCurve();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
